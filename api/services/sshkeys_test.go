...
func TestUpdatePublicKeys(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			expected: Expected{nil, NewErrPublicKeyInvalid([]string{"tags"}, nil)},
		},
		{
...
func TestCreatePublicKeys(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expected: NewErrPublicKeyInvalid([]string{"hostname", "tags"}, nil),
		},
		{
		...
		},
		{
			...
			expected: NewErrPublicKeyInvalid([]string{"data"}, nil),
		},
		{
		...
		},
		{
			...
			expected: NewErrPublicKeyInvalid([]string{"tags"}, nil),
		},
		{
